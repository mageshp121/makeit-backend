  ...
  const exicutefunction = async (Id: string) => {
    ...
    for (let cours of courses) {
      if(process.env.NODE_ENV != "development"){
        ...
        cours.thumbNailImageS3UrlKey = 'https://i.ytimg.com/vi/pN6jk0uUrD8/mqdefault.jpg'
      }
    }
