...
export class course{
    ...
    constructor({WorkingTitle,ShortDescription,Description,Category,WhoIsThiscourseFor,thumbNailImageS3UrlKey,tutorId,WhatWilllearn1,WhatWilllearn2,WhatWilllearn3,WhatWilllearn4 ,prerequesties1,prerequesties2,CoursePrice,drafted}:courseData){
